function [p,dp,negCinv,logdetrm] = logprior_stdnormal(prvec,vr,iirdge,vr0)
% [p,dp,negCinv,logdetrm] = logprior_stdnormal(prvec,vr,iirdge,rhoNull)
%
...
%         p [1 x 1] - log-prior
%        dp [n x 1] - grad
%   negCinv [n x n] - Hessian (negative inverse covariance matrix)
